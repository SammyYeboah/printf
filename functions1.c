...
/* printing unsigned int in octal */
/**
 * print_octal - prints an unsigned integer in the octal notation
 * @types: list of args
...
/* print in either lower or upper */
/**
 * print_hexa - Prints a hexadecimal integer either in lower or upper
 * @types: List of arguments
 * @map_to: Array of values to map the integers
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
